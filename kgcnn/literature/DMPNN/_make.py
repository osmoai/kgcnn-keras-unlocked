...
def make_contrastive_dmpnn_model(name: str = None,
                                inputs: list = None,
                                input_embedding: dict = None,
                                pooling_args: dict = None,
                                edge_initialize: dict = None,
    ...
    r"""Make Contrastive DMPNN model that uses regular DMPNN as base and adds contrastive learning losses.
    
    This is a simple implementation that:
    1. Uses regular DMPNN as the base model
    ...
    Args:
        ...
        dropout (dict): Dictionary of dropout arguments.
        depth (int): Number of DMPNN layers.
