...
from ._grpe_conv import GRPELayer, PoolingNodesGRPE
...
# Implementation of GRPE in `tf.keras` from paper:
# Graph Relative Positional Encoding for Transformers (2022-23)
# Adds relative positional encoding (shortest path distances, graph structure)
...
def make_model(inputs: list = None,
    ...
    r"""Make `GRPE` graph network via functional API.
    Default parameters can be found in :obj:`kgcnn.literature.GRPE.model_default`.
    ...
    Args:
        ...
        grpe_args (dict): Dictionary of layer arguments unpacked in :obj:`GRPELayer` layer.
    ...
    for i in range(depth):
        n = GRPELayer(**grpe_args)([n, e, edge_index_input])
