...
def make_model(name: str = None,
    ...
    if use_graph_state:
        ...
        # Original input order: [node_attributes, node_coordinates, edge_attributes, edge_indices]
    ...
    if use_graph_state:
        model = ks.models.Model(
            inputs=[node_input, xyz_input, edge_index_input, graph_state_input, edge_input],
            outputs=out, 
            name=name)
    else:
        model = ks.models.Model(
