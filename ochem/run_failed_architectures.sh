...
# Script to rerun only the architectures that previously failed
# This tests if the shape mismatch fixes work

echo "🔄 Starting rerun of previously failed architectures..."
...
$python_cmd run_failed_architectures.py
